...
export class Noise {
  ...
  constructor(seed, offsetX, offsetY, offsetZ) {
    // Seed
    console.log("CONSTRUCTOR", seed, offsetX);
    this.seedSaved = seed;
    this.seed(seed || 0);
  ...
  seed(seed) {
    ...
    // Iterate the seed
    for (var i = 0; i < 256; i++) {
      if (i & 1) var v = p[i] ^ (seed & 255);
      else var v = p[i] ^ ((seed >> 8) & 255);
  ...
  curlSimplex3(x, y, z) {
    ...
    var n1 = this.simplex3(x + this.offsetX, y + eps, z);
    var n2 = this.simplex3(x + this.offsetX, y - eps, z);
    // Average to find approximate derivative
    var a = (n1 - n2) / (2 * eps);
    var n1 = this.simplex3(x + this.offsetX, y, z + eps);
    var n2 = this.simplex3(x + this.offsetX, y, z - eps);
    // Average to find approximate derivative
    var b = (n1 - n2) / (2 * eps);
    curl.x = a - b;

    //Find rate of change in XZ plane
    n1 = this.simplex3(x, y + this.offsetY, z + eps);
    n2 = this.simplex3(x, y + this.offsetY, z - eps);
    a = (n1 - n2) / (2 * eps);
    n1 = this.simplex3(x + eps, y + this.offsetY, z);
    n2 = this.simplex3(x - eps, y + this.offsetY, z);
    b = (n1 - n2) / (2 * eps);
    curl.y = a - b;

    //Find rate of change in XY plane
    n1 = this.simplex3(x + eps, y, z + this.offsetZ);
    n2 = this.simplex3(x - eps, y, z + this.offsetZ);
    a = (n1 - n2) / (2 * eps);
    n1 = this.simplex3(x, y + eps, z + this.offsetZ);
    n2 = this.simplex3(x, y - eps, z + this.offsetZ);
    b = (n1 - n2) / (2 * eps);
    curl.z = a - b;
